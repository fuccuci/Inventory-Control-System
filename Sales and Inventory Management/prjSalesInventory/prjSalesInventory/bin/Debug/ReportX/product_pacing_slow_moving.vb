...
Public Class product_pacing_slow_moving
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "product_pacing_slow_moving.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjSalesInventory.product_pacing_slow_moving.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CompLoc() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedproduct_pacing_slow_moving
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As product_pacing_slow_moving = New product_pacing_slow_moving
        rpt.Site = Me.Site
        Return rpt
    End Function
