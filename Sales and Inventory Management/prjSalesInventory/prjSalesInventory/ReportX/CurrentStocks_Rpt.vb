...
Public Class CurrentStocks_Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjSalesInventory.CurrentStocks_Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCurrentStocks_Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CurrentStocks_Rpt = New CurrentStocks_Rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
