...
Public Class Receipt_Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjSalesInventory.Receipt_Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CompTIN() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReceipt_Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Receipt_Rpt = New Receipt_Rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
