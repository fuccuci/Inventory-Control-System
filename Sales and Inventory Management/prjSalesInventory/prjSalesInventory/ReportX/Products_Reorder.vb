...
Public Class Products_Reorder
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjSalesInventory.Products_Reorder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProducts_Reorder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Products_Reorder = New Products_Reorder()
        rpt.Site = Me.Site
        Return rpt
    End Function
