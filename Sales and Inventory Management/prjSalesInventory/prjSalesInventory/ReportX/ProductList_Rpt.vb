...
Public Class ProductList_Rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjSalesInventory.ProductList_Rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProductList_Rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProductList_Rpt = New ProductList_Rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
