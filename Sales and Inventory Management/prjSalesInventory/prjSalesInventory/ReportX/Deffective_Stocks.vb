...
Public Class Deffective_Stocks
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjSalesInventory.Deffective_Stocks.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDeffective_Stocks
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Deffective_Stocks = New Deffective_Stocks()
        rpt.Site = Me.Site
        Return rpt
    End Function
